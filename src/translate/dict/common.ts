...
# ── Местоимения ──
# Без них подстрочник спотыкается на каждой второй фразе письма: «предоставить
# your замечания» читается хуже, чем неправильный, но русский порядок слов.
ваш = your
наш = our
мой = my
их = their
...
# ── Месяцы ──
# В родительном падеже: в письме месяц почти всегда стоит после числа —
# «12 сентября», «by 12 September».
января = January
февраля = February
марта = March
апреля = April
...
# ── Предлоги ──
# Русский предлог многозначен, и единственно верного перевода у него нет. Но
# оставить его русским словом посреди английской строки хуже: подстрочник
# перестаёт читаться вовсе. Берём самое частое значение в их документах.
на = for
в = in
для = for
из = from
