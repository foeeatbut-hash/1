    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl flex items-center gap-4">
          ...
          <div>
            <h4 className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Всего изменений</h4>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl flex items-center gap-4">
          ...
          <div>
            <h4 className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Активных инженеров</h4>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl flex items-center gap-4">
          ...
          <div>
            <h4 className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Последняя запись</h4>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xs overflow-hidden">
        <div className="border-b border-slate-100 dark:border-slate-800/80 px-5 py-4 bg-slate-50/50 dark:bg-slate-900/40 flex items-center justify-between">
          ...
          <span className="text-[10px] text-slate-410 dark:text-slate-500 italic">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1">
                        ...
                        <span className="text-[10px] font-mono font-bold bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded-md text-slate-503">
                          ID: {log.userSymbol}
                        </span>
                        
                        {/* Categorised tag label */}
                        <span className={`text-[10px] px-2 py-0.5 rounded-md font-semibold border flex items-center gap-1 shrink-0 ${cat.color}`}>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-4 shrink-0 mt-2 sm:mt-0 pt-2 sm:pt-0 border-t border-slate-100 sm:border-0 dark:border-slate-800">
                    <div className="text-left sm:text-right space-y-0.5">
                      <div className="text-[11px] font-bold text-slate-700 dark:text-slate-300 font-mono tracking-tight flex items-center sm:justify-end gap-1.5">
                        <Calendar className="w-3.5 h-3.5 text-slate-400" />
                        <span>{formatAbsoluteDate(log.createdAt)}</span>
                      </div>
                      <div className="text-[10px] text-slate-400 dark:text-slate-500 font-mono flex items-center sm:justify-end gap-1">
